...
const landingDictionaries: Record<LandingLocale, LandingCopy> = {
  en: {
    ...
    features: {
      ...
      description: "Multiple layers of intelligence work together to give you the most accurate diagnosis possible.",
      items: [
        {
    ...
    cta: {
      ...
      button: "Start Using Save Crops — Free",
  ...
  km: {
    navigation: {
      links: [
        ...
        { label: "រឿងរ៉ាវរបស់យើង", href: "#our-story" },
      ],
      openBot: "បើក Bot",
    },
    hero: {
    ...
    whatIs: {
      ...
      points: [
        ...
        },
        {
          ...
          description:
            "រចនាឡើងស្របតាមប្រភេទដំណាំក្នុងស្រុក និងរបៀបការងារប្រចាំថ្ងៃរបស់កសិករ តាមរយៈ Telegram។",
        },
      ],
    },
    howItWorks: {
    ...
    features: {
      ...
      description: "ស្រទាប់បច្ចេកវិទ្យាច្រើនធ្វើការរួមគ្នា ដើម្បីផ្តល់លទ្ធផលដែលត្រឹមត្រូវខ្ពស់។",
      items: [
        {
    ...
    ourStory: {
      ...
      title: "ពីមន្ទីរពិសោធន៍ទៅកាន់កសិដ្ឋានពិត",
      paragraphOne:
        "ក្រុមការងារយើងបានទៅខេត្តកំពត ដើម្បីសាកល្បង Save Crop ជាមួយកសិករក្នុងស្ថានភាពកសិកម្មពិតប្រាកដ។",
      paragraphTwo:
        "កសិដ្ឋានជាច្រើនពេញចិត្ត bot របស់យើង ហើយយើងទទួលបានមតិយោបល់ល្អៗជាច្រើន ដែលជួយឱ្យយើងកែលម្អ bot ឱ្យងាយប្រើ លឿន និងមានប្រយោជន៍ជាងមុនសម្រាប់ការងារប្រចាំថ្ងៃរបស់កសិករ។",
    ...
    cta: {
      ...
      button: "ចាប់ផ្តើមប្រើ Save Crops — ឥតគិតថ្លៃ",
